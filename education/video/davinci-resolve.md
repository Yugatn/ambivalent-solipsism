...
Практика по Media, Cut, Edit, Fusion, Color, Fairlight и Deliver. Простые эффекты, keyframes, nodes, звук и экспорт. Горячие клавиши могут зависеть от раскладки и профиля.
