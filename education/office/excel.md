...
Горячие клавиши и формулы с примерами: SUM, AVERAGE, IF, COUNTIF, SUMIF, XLOOKUP, INDEX/MATCH, TEXT, ROUND, FILTER и базовые даты. Синтаксис может зависеть от локали Excel.
